...
<div class="container-fluid">
 ...
 <label for="pt_ins" class="form-label">보험구분</label>
    ...
    <div class="row memo">
        ...
        <textarea id="nurseMemo" class="form-control"></textarea>
        </div>
